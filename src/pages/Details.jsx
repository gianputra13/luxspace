                ...
                >
                  <div className="rounded-xl p-4 pb-8 relative bg-white">
                    <div className="rounded-xl overflow-hidden card-shadow w-full h-36">
                      <div
                        className="bg-gray-300 animate-pulse rounded-lg h-full overview-hidden"
  ...
  return (
    <>
      ...
      <Breadcrumb
        list={[
          { url: "/", name: "Home" },
          { url: "/categories/91822", name: "Office Room" },
          { url: "/categoris/91822/product/123", name: "Details" },
        ]}
      />
      {isError ? (
        <PageErrorMessage
